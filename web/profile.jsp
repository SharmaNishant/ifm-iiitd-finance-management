...
<% String re[] = (String[]) request.getAttribute("profile");// .getAtt("res"); %>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <link rel="shortcut icon" href="../IFM/assets/ico/favicon.png">
    ...
    <!--[if lt IE 9]>
      <script src="../IFM/assets/js/html5shiv.js"></script>
      <script src="../IFM/assets/js/respond.min.js"></script>
    <![endif]-->
  </head>
...
<div class="container">
    ...
    <script src="IFM/assets/js/jquery.js"></script>
