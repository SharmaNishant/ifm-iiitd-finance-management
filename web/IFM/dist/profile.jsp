...
<div class="container">
		...
		<div class="col-sm-3">
			...
			<div class="row">
				...
				<h2><br></h2>
				&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/develop_1.jpg " name = "user_pic"height = "200" width = "200" alt="" class="img-rounded">
				</div>
			</div>
		</div>
		</form>
		...
		<div class="col-sm-4">
			<div class="span4">
				<h1><br></h1>
					<blockquote>
						<h3 name = "user_name">Mayank Garg</h3>
							<p name = "user_no"> 2011065 </p>
							<small><cite title="Source Title" name = "user_loc">Delhi, India  <i class="icon-map-marker"></i></cite></small>
